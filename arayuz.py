...
class KindleizerApp(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Kindleizer v1.5")
        self.setFixedSize(650, 820) # Yükseklik azaltıldı
        ...
        # 8. COPYRIGHT FOOTER
        main_layout.addSpacing(10) # Alt boşluk manuel daraltıldı
    ...
    def process_start(self):
        ...
        if os.path.exists(self.output_path):
            # Diyalog metinlerini kahverengi yapmak için özel mesaj kutusu
